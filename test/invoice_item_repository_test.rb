...
class InvoiceItemRepositoryTest < Minitest::Test
  ...
  def test_it_is_a_member_of_the_invoice_item_class
    ...
    assert_equal InvoiceItem, @iir.find_by_created_at('2012-03-27 14:54:09 UTC').class
    assert_equal InvoiceItem, @iir.find_by_updated_at('2012-03-27 14:54:09 UTC').class
  end
  ...
  def test_it_can_find_an_invoice_item_by_created_at
    assert_equal '2012-03-27 14:54:09 UTC', @iir.find_by_created_at('2012-03-27 14:54:09 UTC').created_at
  end

  def test_it_can_find_an_invoice_item_by_updated_at
  ...
  def test_it_can_find_all_invoice_items_by_created_at
    assert_equal 2, @iir.find_all_by_created_at('2012-03-27 14:54:09 UTC').count
  end

  def test_it_can_find_all_invoice_items_by_updated_at
    assert_equal 2, @iir.find_all_by_updated_at('2012-03-27 14:54:09 UTC').count
  end
  ...
  def test_it_can_return_an_empty_array_when_there_is_no_value
    ...
    assert_equal [], @iir.find_all_by_created_at('')
    assert_equal [], @iir.find_all_by_updated_at('')
  end
end