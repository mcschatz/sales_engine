...
class CustomerRepositoryTest < Minitest::Test
  ...
  def setup
    ...
    customer2 = Customer.new({id: '2', fist_name: 'Timothy', last_name: 'Bigsby', created_at: '2012-02-11 13:43:29 UTC', updated_at: '2011-06-27 14:53:59 UTC'}, self)
  ...
  def test_it_is_a_member_of_the_customer_class
    ...
    assert_equal Customer, @cr.find_by_created_at('2012-02-11 13:43:29 UTC').class
    assert_equal Customer, @cr.find_by_updated_at('2011-06-27 14:53:59 UTC').class
  end
  ...
  #   assert_equal "Bigsby", @cr.find_by_first_name("Bigsby").last_name
  # end

  # def test_it_can_find_a_customer_case_insensitive_first_name
  #   assert_equal "Timothy", @cr.find_by_last_name('timothy').first_name
  # end
  ...
  #   assert_equal '2012-02-11 13:43:29 UTC', @cr.find_by_created_at('2012-02-11 13:43:29 UTC').created_at
  # end

  # def test_it_can_find_a_customer_by_updated_at
  #   assert_equal '2011-06-27 14:53:59 UTC', @cr.find_by_updated_at('2011-06-27 14:53:59 UTC').updated_at
  # end
  ...
  #   assert_equal [], @cr.find_all_by_name('')
  #   assert_equal [], @cr.find_all_by_id('')
  #   assert_equal [], @cr.find_all_by_created_at('')
  #   assert_equal [], @cr.find_all_by_updated_at('')
  # end
end